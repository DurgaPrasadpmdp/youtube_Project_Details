...
const My_Tube = () => {
    ...
    const introAccordianDetails = {
        title:'Introduction',
        description : 'MyTube is a full-featured YouTube clone that I developed from the ground up. This project was designed to mimic the core functionalities of YouTube, providing a platform for users to watch, upload, comment on videos, and subscribe to channels. My goal was to understand and implement the intricate web technologies behind video streaming services, along with user authentication and interaction features.',
        defaultOpen : true,
